...
CREATE TABLE quotes (
    ...
    requested_amount_2 NUMERIC DEFAULT 0,
    requested_amount_3 NUMERIC DEFAULT 0,
    requested_amount_4 NUMERIC DEFAULT 0,
    binding_type TEXT,
    extra_finishes TEXT,
...
-- 4. TIEMPO REAL
-- (Publicación omitida por permisos de Supabase)
...
ALTER TABLE onboarding_requests ADD CONSTRAINT unique_admin_email UNIQUE (admin_email);
