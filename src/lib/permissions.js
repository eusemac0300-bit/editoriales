export const MODULES = [
    ...
    'Ventas', 'Consignaciones', 'Liquidaciones', 'Títulos', 'Autores',
    'Usuarios', 'Documentos', 'Auditoría', 'Alertas'
]

export const DEFAULT_PERMISSIONS = {
    SUPERADMIN: {
        'Dashboard': true, 'Inventario': true, 'Producción': true, 'Escandallo': true, 'Cotizaciones': true,
        'Ventas': true, 'Consignaciones': true, 'Liquidaciones': true, 'Títulos': true, 'Autores': true,
